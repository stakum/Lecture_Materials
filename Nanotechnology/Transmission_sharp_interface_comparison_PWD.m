...
%% Phonon wavepacket dynamics (PWD) result
pwd=[0.1554 0.92666	0.80002
0.4654 0.91241	0.35935
0.9066 0.81723	0.086656
1.2977 1.4092e-12	0];
...
plot(pwd(:,1)/2,pwd(:,2),'bo','MarkerSize',10,'MarkerFaceColor','b')
plot(pwd(:,1)/2,pwd(:,3),'rs','MarkerSize',10,'MarkerFaceColor','r')
xline(sqrt(1/3),'k--','LineWidth',1.5)
grid on
xlabel('$\omega/\omega_0$','Interpreter','latex')
ylabel('Transmittance')
legend('$\beta_{12}/\beta_1=1$(Analytical)',...
    '$\beta_{12}/\beta_1=0.2$(Analytical)',...
    '$\beta_{12}/\beta_1=1$(PWD)',...
    '$\beta_{12}/\beta_1=0.2$(PWD)','Interpreter','latex')
set(ax,'FontSize',18);
